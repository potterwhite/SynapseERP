...
The vault mode parses Obsidian PARA-structured notes; see `docs/architecture/1-for-ai/obsidian_parsing_rules.md` for regex rules.
...
The project phase history and current status are documented in `docs/architecture/2-progress/progress.md`.
The API contracts are in `docs/architecture/1-for-ai/api_spec.md`.
The codebase map (start here for AI agents) is `docs/architecture/1-for-ai/codebase_map.md`.
